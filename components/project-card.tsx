  ...
  return (
    <article className="group relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-card/80 shadow-soft transition duration-300 hover:-translate-y-1 hover:border-white/20">
      ...
      <div className="relative p-4 sm:p-5">
        <div className="relative flex aspect-[16/10] items-end overflow-hidden rounded-[1.35rem] border border-white/10 bg-[linear-gradient(135deg,rgba(15,23,42,0.92),rgba(30,41,59,0.78))] p-4">
          ...
          <div className="relative space-y-2">
            ...
            <p className="max-w-xs text-sm text-slate-200">{project.imageLabel}</p>
          </div>
        </div>
